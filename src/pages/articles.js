        ...
        <Layout className="pt-16">
          ...
          <ul className="grid grid-cols-2 gap-16 lg:gap-8 md:grid-cols-1 md:gap-y-16">
            <FeaturedArticle
              ...
              link="https://www.youtube.com/watch?v=MxXZCD0XF2k"
            />
            ...
            <FeaturedArticle
              ...
              user experience."
              link="https://www.youtube.com/watch?v=V0VfR0eaz98"
            />
          </ul>
          ...
          <ul className="flex flex-col items-center relative">
            <Article
              ...
              link="https://avanibataviya.medium.com/building-reusable-from-input-component-with-error-handling-in-react-hooks-b9f994449191"
            />
            <Article
            ...
            <Article
              ...
              link="https://medium.com/@mohamedkayadconsulting/title-creating-an-efficient-modal-component-in-react-using-hooks-and-portals-b08196a3ef4b"
            />
            <Article
              title="build a fabulous todo list app with react, redux and framer-motion"
              img={blog6}
              date="January 28, 2023"
              link="https://medium.com/@davidarmah2022/building-a-fabulous-todo-list-app-with-react-redux-and-framer-motion-a82c900dfc27"
            />
            <Article
